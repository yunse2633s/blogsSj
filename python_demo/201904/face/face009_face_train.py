# -*- coding: utf-8 -*-
"""
Created on Fri Apr 26 15:01:00 2019
...
from face009_load_data import load_dataset, resize_image, IMAGE_SIZE
...
class Dataset:
    ...
    def load(self, img_rows = IMAGE_SIZE, img_cols = IMAGE_SIZE, 
        ...
        # 另一种解说：https://blog.csdn.net/tangwenbo124/article/details/52627774?locationNum=1&fps=1
        # image_dim_ordering的值与keras的后端应用有关,则假设为 'tf' ,所以可以忽略下面'th'的假设条件
        '''
        ...
        '''
        #  start 假设 K.image_dim_ordering() = 'tf'
        ...
        valid_labels = utils.to_categorical(valid_labels, nb_classes)            
        ...
        # end 假设 K.image_dim_ordering() = 'tf'
...
class Model:
    ...
    def build_model(self, dataset, nb_classes = 4):
        ...
        # github 源码中获悉 border_mode --> padding
        ...
        '''
            ...
            Convolution2D(
                    ...
                    weights=None,
                    border_mode='valid',   # 默认'valid'(不补零，一般情况)  或者'same'(自动补零，使得输出尺寸在过滤窗口步幅为1的情况下与输入尺寸相同，即输出尺寸=输入尺寸/步幅)
    ...
    def train(self, dataset, batch_size = 20, nb_epoch = 10, data_augmentation = True):        
        ...
        #完成实际的模型配置工作,接收三个参数,优化器optimizer,损失函数loss,指标列表metrics
        ...
        #使用实时数据提升
            ...
            #利用生成器开始训练模型
            # github中 samples_per_epoch=>steps_per_epoch,nb_epoch=>epochs
...
IMG_PATH=r'G:\work\vod\axis'
#nb_classes 代表有几个类，几个辨别的事物
...
if __name__ == '__main__':
    ...
    model.build_model(dataset)
    model.train(dataset)
    model.save_model(file_path = IMG_PATH+'/data/face.model.h5')
